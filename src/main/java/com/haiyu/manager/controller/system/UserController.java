...
public class UserController {
    ...
    @ResponseBody
    public Map<String,Object> registerPage(BaseAdminUser user) {
        Map<String,Object> data = new HashMap();
        try{
            BaseAdminUser userResult = baseAdminUserMapper.getUserByUserName(user.getSysUserName(),null);
            if (userResult != null) {
                data.put("code",0);
